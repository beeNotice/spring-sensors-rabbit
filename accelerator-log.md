...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/beeNotice/spring-sensors-rabbit",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "harbor.withtanzu.com/fmartin/tanzu-app-tap",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/b...(truncated), main->main]
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->harbor.withtanzu.com...(truncated)]
